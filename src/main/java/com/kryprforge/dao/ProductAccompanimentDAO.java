...
import com.kryprforge.models.ProductAccompaniment;
...
public class ProductAccompanimentDAO {
    ...
    public List<ProductAccompaniment> findByProductId(long productID) {
        EntityManager em = ENTITY_MANAGER_FACTORY.createEntityManager();
        try {
            return em.createQuery(
                            "SELECT pa FROM ProductAccompaniment pa WHERE pa.product.id = :productId",
                            ProductAccompaniment.class)
